...
<html>
<head>
    <title>Dojo - Edição de Lugar</title>
...
<div class="p-4" style="min-width: 420px;">
    <div class="d-flex justify-content-center mb-4">
        <div class="d-flex align-items-center gap-4">
            <h1 class="h4 m-0">Edição de lugar</h1>
            <a href="/place" class="text-decoration-underline text-muted">Voltar para lista de lugares</a>
        </div>
    </div>

    <form:form method="POST" action="/place/${placeId}/edit" modelAttribute="editPlaceForm" class="d-flex flex-column gap-3">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            <a href="/place" class="btn btn-outline-danger">Cancelar</a>
